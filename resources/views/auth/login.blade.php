...
<div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(27, 67, 50, 0.88) 0%, rgba(45, 106, 79, 0.82) 100%), url('{{ asset('gedung-kejaksaan.jpg') }}'); background-size: cover; background-position: center; color: #FFFFFF; font-family: 'Plus Jakarta Sans', sans-serif; padding: 2rem; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; bottom: -100px; right: -100px; width: 500px; height: 500px; border-radius: 50%; background: radial-gradient(circle, rgba(88, 129, 87, 0.4) 0%, rgba(0,0,0,0) 70%); pointer-events: none;"></div>
    ...
    <div style="width: 100%; max-width: 1240px; display: grid; grid-template-columns: 1.15fr 0.85fr; gap: 4rem; align-items: center; position: relative; z-index: 2;">
        ...
        <div style="padding-right: 1.5rem;">
            ...
            <div style="display: flex; align-items: center; gap: 1.25rem; margin-bottom: 2.5rem;">
                <img src="{{ asset('logo-adhyaksa.png') }}" alt="Logo Kejaksaan Senat Gajah Mada Adhyaksa" style="height: 85px; width: auto; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.3));" />
                <div>
                    <div style="font-weight: 900; font-size: 1.85rem; color: #FFFFFF; line-height: 1.1; letter-spacing: -0.02em;">
                        Litbang Gajah Mada Adhyaksa™
                    </div>
                    <div style="font-size: 0.875rem; color: #D4AF37; font-weight: 900; text-transform: uppercase; letter-spacing: 0.08em; margin-top: 4px;">
            ...
            <h1 style="font-size: clamp(2rem, 3.2vw, 2.75rem); font-weight: 900; line-height: 1.2; color: #FFFFFF; margin-bottom: 1.5rem; letter-spacing: -0.02em;">
                ...
                <span style="color: #D4AF37; text-shadow: 0 4px 15px rgba(212, 175, 55, 0.35);">
                    Pengembangan
                </span>
            </h1>

            <p style="font-size: 1.0625rem; color: #E8F0E8; line-height: 1.75; margin-bottom: 2.75rem; max-width: 540px;">
                Akses pusat kontrol eksekutif LITBANG Senat Gajah Mada Adhyaksa untuk pengisian riset, audit metodologi 3-pintu, dan pengesahan digital dokumen resmi.
            </p>

            <!-- Bottom Action Pills Row -->
            <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
                <a href="{{ route('landing.index') }}" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; border-radius: 9999px; border: 1.5px solid rgba(212, 175, 55, 0.5); background: rgba(255, 255, 255, 0.12); color: #FFFFFF; font-weight: 800; font-size: 0.875rem; backdrop-filter: blur(8px); transition: all 0.2s;">
                    🏠 Beranda Portal Publik
                </a>
                <span style="font-size: 0.875rem; color: #E8F0E8; font-weight: 700;">• Akses Terverifikasi Admin</span>
            </div>
        </div>

        <!-- RIGHT SIDE: FLOATING GLASSMORPHIC FORM CARD -->
        <div>
            <div style="background: rgba(27, 67, 50, 0.78); border: 2px solid #D4AF37; border-radius: 28px; padding: 2.75rem 2.5rem; backdrop-filter: blur(24px); box-shadow: 0 30px 60px rgba(0, 0, 0, 0.4); position: relative;" x-data="{ showPass: false }">
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <p style="font-size: 0.875rem; color: #E8F0E8;">
                ...
                <form action="{{ route('login.post') }}" method="POST" style="display: flex; flex-direction: column; gap: 1.35rem;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.8125rem;">
                        <label style="display: flex; align-items: center; gap: 0.5rem; color: #E8F0E8; cursor: pointer;">
                            <input type="checkbox" name="remember" checked style="width: 16px; height: 16px; accent-color: #D4AF37; cursor: pointer;" />
                            <span>Ingat Sesi Saya</span>
                        </label>
                        <a href="#" style="color: #D4AF37; font-weight: 800; text-decoration: none;">
                            Lupa Password?
                        </a>
                    </div>

                    <!-- Primary Submit Button -->
                    <button type="submit" style="background: linear-gradient(135deg, #D4AF37 0%, #C59B27 100%); color: #04180E; font-weight: 900; font-size: 1rem; padding: 0.95rem; border-radius: 12px; border: none; cursor: pointer; box-shadow: 0 6px 20px rgba(212, 175, 55, 0.35); transition: all 0.2s; margin-top: 0.35rem;">
                        Log In Ke Portal →
                    </button>

                    <!-- KEJAKSAAN RI INTERNAL SECURITY BADGE CARD -->
                    <div style="margin-top: 0.75rem; background: rgba(88, 129, 87, 0.25); border: 1px solid rgba(212, 175, 55, 0.4); border-radius: 12px; padding: 0.75rem 1rem; display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.25rem;">🛡️</span>
                        <div>
                            <div style="font-size: 0.71875rem; font-weight: 900; color: #D4AF37; letter-spacing: 0.04em;">ENKRIPSI KEAMANAN TERVERIFIKASI</div>
                            <div style="font-size: 0.6875rem; color: #E8F0E8; margin-top: 1px;">Sistem Server Terenkripsi SSL 256-bit Kejaksaan RI</div>
                        </div>
                    </div>

                    <!-- Secondary Return Button -->
                    <a href="{{ route('landing.index') }}" style="display: flex; align-items: center; justify-content: center; width: 100%; padding: 0.75rem; border-radius: 12px; border: 1.5px solid rgba(255, 255, 255, 0.2); background: rgba(255, 255, 255, 0.08); color: #FFFFFF; font-weight: 800; font-size: 0.8125rem; text-decoration: none; text-align: center; transition: all 0.2s; margin-top: 0.25rem;">
