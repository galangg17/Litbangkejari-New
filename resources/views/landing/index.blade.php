...
@section('content')
<style>
  /* RESPONSIVE FRESH GREEN SYSTEM */
  :root {
    --color-emerald-dark: #1B4332;
    --color-emerald-medium: #2D6A4F;
    --color-emerald-light: #588157;
    --color-emerald-mint: #E8F0E8;
  ...
  /* HERO BANNER WITH KEJAKSAAN BUILDING PHOTO */
  .fresh-hero-grid {
    display: grid;
    grid-template-columns: 1.15fr 0.85fr;
    gap: 2.5rem;
    align-items: center;
    background: linear-gradient(135deg, rgba(27, 67, 50, 0.90) 0%, rgba(45, 106, 79, 0.82) 100%), url('{{ asset('gedung-kejaksaan.jpg') }}');
  ...
  .fresh-feature-card {
    ...
    box-shadow: 0 10px 30px rgba(27, 67, 50, 0.07);
...
<div x-data="{ 
...
}" style="min-height: 100vh; display: flex; flex-direction: column; width: 100%; box-sizing: border-box;">

    <!-- TOP ANNOUNCEMENT BAR (FRESH GREEN EDITION) -->
    <div style="background: var(--color-emerald-dark); color: #FFFFFF; padding: 0.45rem 1rem; font-size: 0.75rem; border-bottom: 2px solid var(--color-accent-gold); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem;">
        <div style="display: flex; align-items: center; gap: 0.5rem; overflow: hidden; max-width: 100%;">
            <span style="background: var(--color-accent-gold); color: #04140B; font-weight: 900; padding: 0.15rem 0.55rem; border-radius: 4px; font-size: 0.6875rem; flex-shrink: 0;">
                🏛️ PUBLIKASI TERBARU
            </span>
            <div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 700; color: #E8F0E8; font-size: 0.75rem;">
                Executive Policy Brief No. <strong>PB-01/LITBANG-MADA/2026</strong> — Formulasi Pembuktian Digital & SPBE
            </div>
        </div>
        <div style="font-size: 0.71875rem; color: var(--color-accent-gold); font-weight: 900;">
            PORTAL MANAJEMEN PENGETAHUAN GAJAH MADA ADHYAKSA
        </div>
    </div>
    ...
    <div style="position: sticky; top: 0.75rem; z-index: 50; padding: 0 0.75rem; margin: 0.75rem auto 0; width: 100%; max-width: 1200px; box-sizing: border-box;">
        <header class="fresh-navbar-header">
            <div style="display: flex; align-items: center; gap: 0.85rem; cursor: pointer;" onclick="window.location.href='{{ route('landing.index') }}'">
                <img src="{{ asset('logo-adhyaksa.png') }}" alt="Logo Emblem Adhyaksa" style="height: 42px; width: auto; filter: drop-shadow(0 2px 6px rgba(0,0,0,0.2));" />
                <div>
                    ...
                    <div style="font-size: 0.65rem; color: var(--color-accent-gold-dark); font-weight: 900; text-transform: uppercase; margin-top: 1px;">
                        PORTAL RISET, INOVASI & KURIKULUM 2026
                    </div>
                </div>
            </div>
            ...
            <nav class="resp-nav-links">
                ...
                <button @click="isProposalModalOpen = true" style="background: linear-gradient(135deg, var(--color-emerald-dark) 0%, var(--color-emerald-medium) 100%); color: var(--color-accent-gold); font-weight: 900; font-size: 0.8125rem; padding: 0.5rem 1.15rem; border-radius: 9999px; border: 1px solid var(--color-accent-gold); cursor: pointer; box-shadow: 0 4px 14px rgba(27, 67, 50, 0.25);">
                    ⚡ Ajukan Usulan (PIN)
                </button>
    ...
    <main class="resp-container" style="flex: 1; padding-top: 1.5rem; padding-bottom: 4rem;">
        ...
        <section class="fresh-hero-grid" style="margin-bottom: 2rem;">
            ...
            <div style="position: relative; z-index: 2;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.35rem 0.85rem; background: rgba(212, 175, 55, 0.18); border: 1.5px solid var(--color-accent-gold); border-radius: 9999px; font-size: 0.71875rem; font-weight: 900; color: var(--color-accent-gold); margin-bottom: 1.25rem; text-transform: uppercase;">
                    <span>🏛️ KEJAKSAAN REPUBLIK INDONESIA</span>
                </div>

                <h1 style="font-size: clamp(1.85rem, 3.5vw, 2.75rem); font-weight: 900; line-height: 1.18; color: #FFFFFF; margin-bottom: 1rem; letter-spacing: -0.01em;">
                    Transformasi Riset, Inovasi <br />
                    <span style="color: var(--color-accent-gold); text-shadow: 0 4px 15px rgba(212,175,55,0.3);">
                        & Kurikulum Pembelajaran
                    </span>
                </h1>

                <p style="font-size: 0.9375rem; color: #E8F0E8; line-height: 1.65; margin-bottom: 1.75rem; max-width: 580px;">
                    Portal repositori manajemen pengetahuan terpadu Angkatan Gajah Mada Adhyaksa (PPPJ LXXXIII/2026). Akses naskah akademis teruji, bank inovasi digital, dan modul pembelajaran.
                </p>

                <!-- Hero Action Buttons -->
                <div style="display: flex; gap: 0.85rem; flex-wrap: wrap; align-items: center;">
                    <a href="#katalog-hub" style="background: linear-gradient(135deg, var(--color-accent-gold) 0%, var(--color-accent-gold-dark) 100%); color: #04140B; font-weight: 900; font-size: 0.875rem; padding: 0.75rem 1.5rem; border-radius: 12px; text-decoration: none; box-shadow: 0 6px 20px rgba(212, 175, 55, 0.35); display: inline-flex; align-items: center; gap: 0.4rem;">
                        🌐 Jelajahi Vault Naskah
                    </a>
                    <button @click="isProposalModalOpen = true" style="background: rgba(255,255,255,0.12); border: 1.5px solid rgba(255,255,255,0.35); color: #FFFFFF; font-weight: 800; font-size: 0.875rem; padding: 0.75rem 1.35rem; border-radius: 12px; cursor: pointer; backdrop-filter: blur(8px); display: inline-flex; align-items: center; gap: 0.4rem;">
                        📥 Kirim Usulan (PIN)
                    </button>
                </div>
            </div>
            ...
            <div style="position: relative; z-index: 2;">
                <template x-if="policyBriefs && policyBriefs.length > 0">
                    <div style="background: rgba(255, 255, 255, 0.95); border: 2px solid var(--color-accent-gold); border-radius: 24px; padding: 1.65rem; color: var(--color-text-dark); box-shadow: 0 25px 50px rgba(0, 0, 0, 0.3); backdrop-filter: blur(16px);">
        ...
        <!-- 4 FEATURE CARDS ROW (FRESH GREEN STYLE) -->
        <section class="fresh-feature-row" style="margin-bottom: 3.5rem;">
            <!-- CARD 1 -->
            <div class="fresh-feature-card">
                <div style="width: 42px; height: 42px; border-radius: 12px; background: var(--color-emerald-mint); color: var(--color-emerald-dark); font-size: 1.2rem; display: flex; align-items: center; justify-content: center; margin-bottom: 0.85rem;">
                    📄
                </div>
                <h4 style="font-size: 0.95rem; font-weight: 900; color: var(--color-emerald-dark); margin-bottom: 0.35rem;">Policy Brief Studio</h4>
                <p style="font-size: 0.78125rem; color: var(--color-text-muted); line-height: 1.5;">Naskah akademis teruji dengan pengesahan digital QR Seal resmi Kejaksaan RI.</p>
            </div>

            <!-- CARD 2 -->
            <div class="fresh-feature-card">
                <div style="width: 42px; height: 42px; border-radius: 12px; background: #E0F2FE; color: #0284C7; font-size: 1.2rem; display: flex; align-items: center; justify-content: center; margin-bottom: 0.85rem;">
                    💡
                </div>
                <h4 style="font-size: 0.95rem; font-weight: 900; color: var(--color-emerald-dark); margin-bottom: 0.35rem;">Bank Inovasi Teruji</h4>
                <p style="font-size: 0.78125rem; color: var(--color-text-muted); line-height: 1.5;">Katalog inovasi digital & birokrasi pendukung efisiensi tata kelola penegakan hukum.</p>
            </div>

            <!-- CARD 3 -->
            <div class="fresh-feature-card">
                <div style="width: 42px; height: 42px; border-radius: 12px; background: #DCFCE7; color: #16A34A; font-size: 1.2rem; display: flex; align-items: center; justify-content: center; margin-bottom: 0.85rem;">
                    📚
                </div>
                <h4 style="font-size: 0.95rem; font-weight: 900; color: var(--color-emerald-dark); margin-bottom: 0.35rem;">Vault Kurikulum PPPJ</h4>
                <p style="font-size: 0.78125rem; color: var(--color-text-muted); line-height: 1.5;">Arsip modul, slide materi, dan juknis pembelajaran angkatan terverifikasi.</p>
            </div>

            <!-- CARD 4 (HIGHLIGHTED EMERALD) -->
            <div class="fresh-feature-card highlight">
                <div style="width: 42px; height: 42px; border-radius: 12px; background: rgba(212,175,55,0.2); color: var(--color-accent-gold); font-size: 1.2rem; display: flex; align-items: center; justify-content: center; margin-bottom: 0.85rem;">
                    🏛️
                </div>
                <h4 style="font-size: 0.95rem; font-weight: 900; color: #FFFFFF; margin-bottom: 0.35rem;">Pokja Gajah Mada</h4>
                <p style="font-size: 0.78125rem; color: #E8F0E8; line-height: 1.5;">Pusat komando penelitian dan formulasi kebijakan riset angkatan.</p>
            </div>
        </section>
        ...
        <section class="fresh-split-section">
            ...
            <div class="fresh-stats-grid">
                <div class="fresh-stat-box" style="border-left: 4px solid var(--color-emerald-dark);">
                    <div style="font-size: 2.25rem; font-weight: 900; color: var(--color-emerald-dark); line-height: 1;">500+</div>
                    <div style="font-size: 0.78125rem; font-weight: 800; color: var(--color-text-dark); margin-top: 6px;">Peserta Angkatan</div>
                    <div style="font-size: 0.6875rem; color: var(--color-text-muted); margin-top: 2px;">PPPJ LXXXIII/2026</div>
                </div>

                <div class="fresh-stat-box" style="border-left: 4px solid #0284C7;">
                    <div style="font-size: 2.25rem; font-weight: 900; color: #0284C7; line-height: 1;">40+</div>
                    <div style="font-size: 0.78125rem; font-weight: 800; color: var(--color-text-dark); margin-top: 6px;">Policy Briefs Terbit</div>
                    <div style="font-size: 0.6875rem; color: var(--color-text-muted); margin-top: 2px;">Teruji Akademis</div>
                </div>

                <div class="fresh-stat-box" style="border-left: 4px solid #86198F;">
                    <div style="font-size: 2.25rem; font-weight: 900; color: #86198F; line-height: 1;">15+</div>
                    <div style="font-size: 0.78125rem; font-weight: 800; color: var(--color-text-dark); margin-top: 6px;">Inovasi Teruji</div>
                    <div style="font-size: 0.6875rem; color: var(--color-text-muted); margin-top: 2px;">Digital & Birokrasi</div>
                </div>

                <div class="fresh-stat-box" style="border-left: 4px solid #16A34A;">
                    <div style="font-size: 2.25rem; font-weight: 900; color: #16A34A; line-height: 1;">100%</div>
                    <div style="font-size: 0.78125rem; font-weight: 800; color: var(--color-text-dark); margin-top: 6px;">Stempel QR Seal</div>
                    <div style="font-size: 0.6875rem; color: var(--color-text-muted); margin-top: 2px;">Autentik Digital</div>
                </div>
            </div>

            <!-- RIGHT ABOUT DESCRIPTION -->
            <div style="background: #FFFFFF; border: 1.5px solid #E2E8F0; border-radius: 24px; padding: 2.25rem; box-shadow: 0 10px 30px rgba(27,67,50,0.06);">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.3rem 0.75rem; background: var(--color-emerald-mint); border-radius: 9999px; font-size: 0.71875rem; font-weight: 900; color: var(--color-emerald-dark); text-transform: uppercase; margin-bottom: 1rem;">
                    <span>🌱 TENTANG LITBANG GAJAH MADA ADHYAKSA</span>
                </div>
                <h2 style="font-size: 1.65rem; font-weight: 900; color: var(--color-emerald-dark); line-height: 1.25; margin-bottom: 1rem;">
                    Mengabdi Melalui Formulasi Riset & Inovasi Penegakan Hukum
                </h2>
                <p style="font-size: 0.875rem; color: var(--color-text-muted); line-height: 1.7; margin-bottom: 1.25rem;">
                ...
                <div style="display: flex; gap: 0.75rem; align-items: center;">
                    <a href="#lacak-tiket-hub" style="background: var(--color-emerald-dark); color: var(--color-accent-gold); font-weight: 900; font-size: 0.8125rem; padding: 0.6rem 1.25rem; border-radius: 10px; text-decoration: none; display: inline-flex; align-items: center; gap: 0.3rem;">
        ...
        <section id="katalog-hub" style="margin: 4rem 0;">
            <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
                <div>
                    ...
                    <h2 style="font-size: 1.75rem; font-weight: 900; color: var(--color-emerald-dark); margin-top: 0.25rem;">Katalog Pengetahuan 3 Pilar</h2>
                </div>
            ...
            <div style="background: #FFFFFF; border: 1.5px solid #CBD5E1; padding: 1rem 1.25rem; border-radius: 18px; margin-bottom: 1.75rem; display: flex; flex-direction: column; gap: 0.85rem; box-shadow: 0 4px 16px rgba(0,0,0,0.03);">
                <div style="position: relative;">
                    <input type="text" x-model="searchQuery" placeholder="🔍 Cari judul naskah, inovasi, pengusul, atau modul secara instan..." style="width: 100%; background: #F8FAFC; border: 1.5px solid #CBD5E1; border-radius: 10px; padding: 0.65rem 1rem; color: var(--color-text-dark); font-size: 0.875rem; outline: none;" />
                </div>
                    ...
                    <div class="fresh-catalog-card" x-show="(activeCategory === 'Semua' || '{{ $brief->category }}'.includes(activeCategory)) && (searchQuery === '' || '{{ strtolower($brief->title . ' ' . $brief->summary . ' ' . $brief->category . ' ' . $brief->doc_no) }}'.includes(searchQuery.toLowerCase()))">
                        <div>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
                                <span style="font-size: 0.72rem; font-weight: 900; color: var(--color-emerald-dark); background: var(--color-emerald-mint); padding: 0.2rem 0.6rem; border-radius: 6px;">
                                    📄 {{ $brief->category }}
                                </span>
                                <span style="font-size: 0.72rem; color: var(--color-text-muted); font-weight: 800;">{{ $brief->doc_no }}</span>
                            </div>
                        ...
                        <div style="border-top: 1px solid #F1F5F9; padding-top: 0.85rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                            <span style="font-size: 0.72rem; color: #16A34A; font-weight: 800;">🟢 QR Seal Verified</span>
                            <div style="display: flex; gap: 0.4rem;">
                                <button type="button" style="background: var(--color-emerald-mint); border: 1px solid var(--color-emerald-medium); color: var(--color-emerald-dark); font-weight: 800; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; cursor: pointer;" @click="openPdfPreview(policyBriefs[{{ $loop->index }}].title, policyBriefs[{{ $loop->index }}].doc_no, policyBriefs[{{ $loop->index }}].file_path)">
                                    👁️ Pratinjau
                                </button>
                                <a href="{{ route('catalog.download', ['kajian', $brief->id]) }}" style="background: var(--color-emerald-dark); color: var(--color-accent-gold); font-weight: 900; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; text-decoration: none;">
                                    📥 Download
                                </a>
                            </div>
                        </div>
            ...
            <div x-show="activeMainTab === 'innovation'" x-cloak class="fresh-catalog-grid">
                @foreach($innovations as $inov)
                    <div class="fresh-catalog-card" x-show="(activeCategory === 'Semua' || '{{ $inov->category }}'.includes(activeCategory)) && (searchQuery === '' || '{{ strtolower($inov->title . ' ' . $inov->summary . ' ' . $inov->category . ' ' . $inov->innovation_no) }}'.includes(searchQuery.toLowerCase()))">
                        <div>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
                                <span style="font-size: 0.72rem; font-weight: 900; color: #0284C7; background: #E0F2FE; padding: 0.2rem 0.6rem; border-radius: 6px;">
                                    💡 {{ $inov->status }}
                                </span>
                                <span style="font-size: 0.72rem; color: var(--color-text-muted); font-weight: 800;">{{ $inov->innovation_no }}</span>
                            </div>
                        ...
                        <div style="border-top: 1px solid #F1F5F9; padding-top: 0.85rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                            ...
                            <div style="display: flex; gap: 0.4rem;">
                                <button type="button" style="background: #E0F2FE; border: 1px solid #7DD3FC; color: #0369A1; font-weight: 800; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; cursor: pointer;" @click="openPdfPreview(innovations[{{ $loop->index }}].title, innovations[{{ $loop->index }}].innovation_no, innovations[{{ $loop->index }}].sop_file_path)">
                                    👁️ Pratinjau
                                </button>
                                <a href="{{ route('catalog.download', ['innovation', $inov->id]) }}" style="background: #0284C7; color: #FFFFFF; font-weight: 900; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; text-decoration: none;">
                                    📥 SOP PDF
                                </a>
                            </div>
                        </div>
            ...
            <div x-show="activeMainTab === 'curriculum'" x-cloak class="fresh-catalog-grid">
                @foreach($curriculums as $curr)
                    <div class="fresh-catalog-card" x-show="(activeCategory === 'Semua' || '{{ $curr->subject_category }}'.includes(activeCategory)) && (searchQuery === '' || '{{ strtolower($curr->title . ' ' . $curr->subject_category . ' ' . $curr->file_type) }}'.includes(searchQuery.toLowerCase()))">
                        <div>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
                                <span style="font-size: 0.72rem; font-weight: 900; color: #16A34A; background: #DCFCE7; padding: 0.2rem 0.6rem; border-radius: 6px;">
                                    📚 {{ $curr->file_type }}
                                </span>
                                <span style="font-size: 0.72rem; color: var(--color-text-muted); font-weight: 800;">Bidang: {{ $curr->subject_category }}</span>
                            </div>
                        ...
                        <div style="border-top: 1px solid #F1F5F9; padding-top: 0.85rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                            <span style="font-size: 0.72rem; color: #16A34A; font-weight: 800;">🎓 Terverifikasi</span>
                            <div style="display: flex; gap: 0.4rem;">
                                @if($curr->external_link)
                                    <a href="{{ $curr->external_link }}" target="_blank" rel="noopener noreferrer" style="background: linear-gradient(135deg, #0EA5E9 0%, #0284C7 100%); color: #FFF; font-weight: 900; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; text-decoration: none;">
                                        🔗 Drive
                                    </a>
                                @endif
                                @if($curr->file_path)
                                    <button type="button" style="background: #DCFCE7; border: 1px solid #86EFAC; color: #15803D; font-weight: 800; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; cursor: pointer;" @click="previewCurriculum(curriculums[{{ $loop->index }}])">
                                        👁️ Pratinjau
                                    </button>
                                    <a href="{{ $curr->file_path }}" download style="background: #16A34A; color: #FFFFFF; font-weight: 900; font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 8px; text-decoration: none;">
                                        📥 Unduh
                                    </a>
                                @endif
                            </div>
        ...
        <!-- CURVED BANNER FOR QUICK SUBMISSION (FRESH GREEN EDITION) -->
        <section class="fresh-banner-curved" id="lacak-tiket-hub">
            <div style="max-width: 720px; position: relative; z-index: 2;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.3rem 0.75rem; background: rgba(212, 175, 55, 0.2); border: 1px solid var(--color-accent-gold); border-radius: 9999px; font-size: 0.71875rem; font-weight: 900; color: var(--color-accent-gold); text-transform: uppercase; margin-bottom: 1rem;">
                ...
                <p style="font-size: 0.9375rem; color: #E8F0E8; line-height: 1.65; margin-bottom: 1.75rem;">
                ...
                <div style="display: flex; gap: 0.85rem; flex-wrap: wrap;">
                    <button @click="isProposalModalOpen = true" style="background: linear-gradient(135deg, var(--color-accent-gold) 0%, var(--color-accent-gold-dark) 100%); color: #04140B; font-weight: 900; font-size: 0.875rem; padding: 0.8rem 1.65rem; border-radius: 12px; border: none; cursor: pointer; box-shadow: 0 6px 20px rgba(212, 175, 55, 0.4);">
                        ⚡ Kirim Usulan Riset Baru (PIN)
                    </button>
                    <button @click="isCurriculumUploadModalOpen = true" style="background: rgba(255,255,255,0.12); border: 1.5px solid rgba(255,255,255,0.35); color: #FFFFFF; font-weight: 800; font-size: 0.875rem; padding: 0.8rem 1.5rem; border-radius: 12px; cursor: pointer;">
    ...
    <!-- FOOTER (FRESH EMERALD GREEN EDITION) -->
    <footer style="border-top: 2px solid var(--color-accent-gold); padding: 2rem 1rem; text-align: center; color: #E8F0E8; background: var(--color-emerald-dark);">
        <div class="resp-container" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.75rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="{{ asset('logo-adhyaksa.png') }}" alt="Logo Adhyaksa" style="height: 36px; width: auto;" />
                <div style="text-align: left;">
                    <div style="font-weight: 900; color: var(--color-accent-gold); font-size: 0.875rem;">Portal Manajemen Pengetahuan — LITBANG 2026</div>
                    <div style="font-size: 0.71875rem; color: #CBD5E1;">Gajah Mada Adhyaksa (PPPJ LXXXIII/II Tahun 2026)</div>
                </div>
            </div>
            <div style="font-size: 0.75rem; color: #CBD5E1;">© 2026 Litbang Gajah Mada Adhyaksa. All Rights Reserved.</div>
        </div>
    </footer>
</div>
@endsection
